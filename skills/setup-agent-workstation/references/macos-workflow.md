...
5. Have a human create named, assigned `admin-NN`, and non-admin `agent-NN` accounts through approved macOS/MDM procedures.
...
7. Install tooling under `agent-NN`; authenticate model/source-control identities through Keychain or the chosen secrets manager.
